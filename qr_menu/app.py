...
class Kategori(db.Model):
    ...
    isim_ru     = db.Column(db.String(80),  default='')
    isim_it     = db.Column(db.String(80),  default='')
    isim_ar     = db.Column(db.String(80),  default='')
    isim_de     = db.Column(db.String(80),  default='')
    isim_fr     = db.Column(db.String(80),  default='')
    aciklama    = db.Column(db.String(255), default='')
    aciklama_en = db.Column(db.String(255), default='')
    aciklama_ru = db.Column(db.String(255), default='')
    aciklama_it = db.Column(db.String(255), default='')
...
class Urun(db.Model):
    ...
    isim_ar         = db.Column(db.String(120), default='')
    ...
    aciklama_ar     = db.Column(db.Text, default='')
...
def t_urun_ekle(slug, tenant, me):
    ...
    db.session.add(Urun(
        ...
        isim_ar=clean(request.form.get('isim_ar')),
        ...
        aciklama_ar=clean(request.form.get('aciklama_ar')),
        ...
        alerjen_notu=clean(request.form.get('alerjen_notu')),
        alerjen_notu_en=clean(request.form.get('alerjen_notu_en')),
    ))
...
def t_urun_duzenle(slug, tenant, me, uid):
    ...
    u.isim_ar     = clean(request.form.get('isim_ar'))
    ...
    u.aciklama_ar = clean(request.form.get('aciklama_ar'))
    ...
    u.alerjen_notu   = clean(request.form.get('alerjen_notu'))
    u.alerjen_notu_en = clean(request.form.get('alerjen_notu_en'))
    fiyat_degisti = False
